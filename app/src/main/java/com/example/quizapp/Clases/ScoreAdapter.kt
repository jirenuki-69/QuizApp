...
class ScoreAdapter(val scores: List<Score>) : RecyclerView.Adapter<ScoreAdapter.ViewHolder>() {
...
//            NumberOfQuestionsTextView.text = score.numberOfQuestions.toString()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.score_item_layout, parent, false)
        )
    }
